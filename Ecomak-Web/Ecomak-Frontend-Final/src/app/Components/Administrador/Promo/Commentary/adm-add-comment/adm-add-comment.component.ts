...
@Component({
  selector: 'app-adm-add-comment',
  templateUrl: './adm-add-comment.component.html',
  styleUrls: ['./adm-add-comment.component.css']
})
export class AdmAddCommentComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, public dialogRef: MatDialogRef<AdmAddCommentComponent>,
