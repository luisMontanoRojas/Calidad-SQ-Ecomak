...
@Component({
  selector: 'app-adm-subir-imagen',
  templateUrl: './adm-subir-imagen.component.html',
  styleUrls: ['./adm-subir-imagen.component.css']
})
export class AdmSubirImagenComponent implements OnInit {
